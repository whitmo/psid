...
def after_install(options, home_dir):
    ...
    subprocess.call([join(bin_dir, 'easy_install'), 'PasteDeploy'])
    subprocess.call([join(bin_dir, 'easy_install'), 'simplejson'])
    subprocess.call([join(bin_dir, 'easy_install'), 'WebOb'])
    subprocess.call([join(bin_dir, 'easy_install'), 'WebTest'])
    subprocess.call([join(bin_dir, 'easy_install'), 'decorator'])
    subprocess.call([join(bin_dir, 'easy_install'), 'selector'])
    subprocess.call([join(bin_dir, 'easy_install'), 'static'])
    subprocess.call([join(bin_dir, 'easy_install'), 'zc.buildout'])
    subprocess.call([join(bin_dir, 'easy_install'), 'zc.recipe.egg'])
    subprocess.call([join(bin_dir, 'easy_install'), 'hexagonit.recipe.cmmi'])
